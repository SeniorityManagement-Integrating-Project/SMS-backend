...
def to_seniority_level(seniority_level: SeniorityLevelCreate | SeniorityLevelUpdate) -> SeniorityLevel:
    return SeniorityLevel(**seniority_level.dict())


def update_seniority_level(seniority_level_db: SeniorityLevel, seniority_level: SeniorityLevelUpdate) -> SeniorityLevel:
